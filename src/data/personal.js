const personal = {
  ...
  interests: [
    ...
    },
    {
      ...
      type: "media-fan",
      mediaStack: [
        `${import.meta.env.BASE_URL}assets/images/personal/media-stack/dark-souls-3.jpg`,
        `${import.meta.env.BASE_URL}assets/images/personal/media-stack/interstellar.jpg`,
        `${import.meta.env.BASE_URL}assets/images/personal/media-stack/horus-heresy.jpg`,
        `${import.meta.env.BASE_URL}assets/images/personal/media-stack/elden-ring.jpg`,
        `${import.meta.env.BASE_URL}assets/images/personal/media-stack/lord-of-the-rings.jpg`,
        `${import.meta.env.BASE_URL}assets/images/personal/media-stack/final-fantasy-7.jpg`,
      ],
    },
    {
      id: "miniatures",
      ...
      image: `${import.meta.env.BASE_URL}assets/images/personal/miniatures.webp`,
    ...
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}assets/images/personal/guitar.webp`,
